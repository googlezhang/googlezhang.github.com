...
function Spartan_setup(){
  ...
  $custombgargs = array(
	...
	'default-image' => get_template_directory_uri() . '/images/page_bg.png',
	);
 ...
 * limit = int
 */
function Spartan_twitter_script($unique_id,$username,$limit) {
?>
<script type="text/javascript">
<!--//--><![CDATA[//><!--
...
<![endif]--> ';
								...
								wp_enqueue_style('Spartan_wilto', get_stylesheet_directory_uri().'/css/wilto.css');
									...
									if( of_get_option('skin_style') == 'black' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/black.css');
									}elseif( of_get_option('skin_style') == 'blue' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/blue.css');										
									}elseif( of_get_option('skin_style') == 'brown' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/brown.css');										
									}elseif( of_get_option('skin_style') == 'green' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/green.css');										
									}elseif( of_get_option('skin_style') == 'orange' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/orange.css');										
										...
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/purple.css');										
									}elseif( of_get_option('skin_style') == 'red' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/red.css');										
									}elseif( of_get_option('skin_style') == 'yellow' ) {
										wp_enqueue_style('Spartan_sliderbg', get_stylesheet_directory_uri().'/css/slider/yellow.css');										
									}else {
									...
									?>
										<style type="text/css">
                                                .magfive_title h2 a{ color:<?php echo of_get_option('post_title_color'); ?> }
												.actual_post_title h2 a{ color:<?php echo of_get_option('post_title_color'); ?> !important}
												.actual_post_title_page h2{ color:<?php echo of_get_option('post_title_color'); ?> !important}
												<?php echo '#menu{background:',( of_get_option('menu_color') ) ? of_get_option('menu_color') : '#C8C7C7',';}'; ?>
                                        </style>	
									<?php  									
...
function Spartan_add_javascript( ) {
	...
	if( !is_admin() ) {
		...
		wp_enqueue_script('Spartan_jquery', get_template_directory_uri().'/js/jquery-1.7.2.min.js' );
		wp_enqueue_script('Spartan_tabcontent', get_template_directory_uri().'/js/tabcontent.js' );
 ...
 */
function Spartan_quickYouTubeId($youtubeurl) {
