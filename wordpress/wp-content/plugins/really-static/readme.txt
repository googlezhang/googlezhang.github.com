...
If you have problems, informations about bugs or ideas [report them to us](http://really-static-support.php-welt.net/bugs-f8.html).

**Advantages:**

 * its incredible fast, faster than any cache solution
 * saving static files via local, FTP, SFTP, ( and also on Amazons S3 CDN with a [plugin]{http://really-static-support.php-welt.net/amazon-s3-plugin-t7.html} )
...
Or ask the [community](http://really-static-support.php-welt.net/bugs-f8.html)
