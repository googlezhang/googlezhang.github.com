                        ...
                        <div id="sidebar_section">
                            ...
                            <div id="feed_social">
                                            ...
                                            <div id="sidebar_facebook">
                                            	...
                                            	<p><a href="<?php echo of_get_option('facebook_id'); ?>"><?php _e('Be A Fan On Facebook', 'Spartan') ?></a></p>
                                            ...
                                            <div id="sidebar_twitter">
                                            	...
                                            	<p><a href="http://www.twitter.com/<?php echo of_get_option('twitter_id'); ?>"><?php _e('Follow On Twitter',  'Spartan') ?></a></p>                                            
										...
										<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('default') ){
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Categories', 'Spartan') ?></h3>
																				<ul>
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Archives', 'Spartan') ?></h3>
																				<ul>
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Blogrolls', 'Spartan') ?></h3>
																				<ul>
